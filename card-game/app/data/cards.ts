...
export const cards: Card[] = [
  ...
  { id: 7, name: "回復の呪文", type: "spell", description: "味方1体を回復", effect: "heal_single", effectValue: 2, image: `${basePath}/img/cards/heal_spell.png`, uniqueId: "", cost: 2 },
  { id: 8, name: "槍兵", type: "follower", description: "相手ヒーローへ攻撃時にボーナスダメージ", attack: 2, hp: 2, maxHp: 2, image: `${basePath}/img/cards/spearman.png`, uniqueId: "", cost: 2, onAttackEffect: "bonus_vs_hero" },
  ...
  { id: 15, name: "加速の呪文", type: "spell", description: "出したフォロワーに突進/即攻撃を与える", effect: "haste", status: "haste", statusDuration: 1, image: `${basePath}/img/cards/haste_spell.png`, uniqueId: "", cost: 1 },
